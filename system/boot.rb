...
# The file is responsible for loading all configuration files.
...
# Register automatically application classes and the external dependencies from
# the system/boot folder.
