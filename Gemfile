...
# bcrypt-ruby is a Ruby binding for the OpenBSD brcrypt() password hashing
# algorithm, allowing you to easily store a secure hash of your user's passwords.
gem "bcrypt"
...
# dead simple to test time-dependent code. It provides a unified method to mock
